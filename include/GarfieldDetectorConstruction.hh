...
private:
  ...
  G4VPhysicalVolume *fGlassPV; // the absorber physical volume
  G4VPhysicalVolume *fGas1PV;     // the gas physical volume
  G4VPhysicalVolume *fGas2PV;     // the gas physical volume

  G4VPhysicalVolume *freadoutPV; // the wire physical volume

  G4LogicalVolume *gas1LV;
  G4LogicalVolume *gas2LV;
